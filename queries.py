...
query_insert_all_products = "INSERT INTO {table} ({f1}, {f2}, {f3}, {f4}, {f5}, {f6}, {f7}, {f8}, {f9}, {f10}, {f11}, {f12}, {f13}, {f14}, {f15}) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
...
insert_a_substitute = "INSERT INTO {table} ({f1}, {f2}, {f3}, {f4}, {f5}, {f6}, {f7}, {f8}, {f9}, {f10}, {f11}, {f12}, {f13}, {f14}, {f15}) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
